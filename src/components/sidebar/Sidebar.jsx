...
import logo from '../images/nico.jpg';
...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/CoolRadish'
    },
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/nico-baluyut-288187313/'
    },
    {
      component: stackoverflow,
      href: 'https://stackoverflow.com/users/25532683/nico-baluyut'
    },
    {
      component: gmail,
      href: 'mailto:nico.baluyut.dev@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      <div className='topHashtag'>Make your dreams a reality</div>
      <div className='topHashtag'>Ability is a key of success</div>
      <div className='topHashtag'>Hire me</div>
      <h1>
